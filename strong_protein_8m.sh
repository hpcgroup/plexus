...
PARTITIONED_DATA_DIR=/pscratch/sd/c/cunyang/gnn/plexus/dataset/protein_8m/protein_part${PARTITIONS_PER_DIM}
...
SCRIPT="$TRAIN_FILE \
    ...
    echo $run_cmd
    eval $run_cmd > strong/protein_8m/protein_8m_G_INTRA_R${G_INTRA_R}_G_INTRA_C${G_INTRA_C}_G_INTRA_D${G_INTRA_D}_G_DATA${G_DATA}_ratio${ratio}.log 2>&1
    # eval $run_cmd