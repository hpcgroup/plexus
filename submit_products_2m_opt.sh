...
SCRIPT="$TRAIN_FILE \
    ...
    echo $run_cmd
    eval $run_cmd > opt/products_2m_G_DATA${G_DATA}_baseline.log 2>&1
...
SCRIPT="$TRAIN_FILE \
    ...
    echo $run_cmd
    eval $run_cmd > opt/products_2m_G_DATA${G_DATA}_sampopt.log 2>&1
...
SCRIPT="$TRAIN_FILE \
    ...
    echo $run_cmd
    eval $run_cmd > opt/products_2m_G_DATA${G_DATA}_sampopt_bf16.log 2>&1
...
SCRIPT="$TRAIN_FILE \
    ...
    echo $run_cmd
    eval $run_cmd > opt/products_2m_G_DATA${G_DATA}_sampopt_bf16_kernel.log 2>&1
...
SCRIPT="$TRAIN_FILE \
    ...
    echo $run_cmd
    eval $run_cmd > opt/products_2m_G_DATA${G_DATA}_sampopt_bf16_kernel_overlap.log 2>&1
