...
#flux: -t 20m
#flux: -q pbatch
#flux: --output "job-logs/strong_products_14m_{{nnodes}}N_{{id}}.log"
...
PARTITIONED_DATA_DIR=./dataset/amazon_14m/amazon_part${PARTITIONS_PER_DIM}
...
echo $run_cmd
eval $run_cmd > results/products_14m_G_INTRA_R${G_INTRA_R}_G_INTRA_C${G_INTRA_C}_G_INTRA_D${G_INTRA_D}_G_DATA${G_DATA}_ratio${ratio}.log 2>&1
